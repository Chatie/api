# Chatie Restful API
![OpenAPI 2.0 Schema Validation](http://online.swagger.io/validator?url=https://raw.githubusercontent.com/Chatie/api/master/spec/swagger.yaml "OpenAPI Validation")
